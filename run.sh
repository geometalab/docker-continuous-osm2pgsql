...
osm2pgsql_hstore=${hstore:---hstore}
osm2pgsql_base_args="--number-processes ${num_processes} -H database -U gis -d gis --slim -C ${osm2pgsql_ram_cache} --flat-nodes ${osm_cache} --prefix ${osm2pgsl_table_prefix} ${osm2pgsql_hstore} --latlon"
